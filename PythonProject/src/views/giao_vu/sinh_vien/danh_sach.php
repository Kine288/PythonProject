...
<head>
    ...
    <style>
        ...
        .card { background: #fff; border: 1px solid #e5edf5; border-radius: 14px; padding: 16px; margin-bottom: 16px; }
        ...
        button { background: #0f766e; color: #fff; font-weight: 600; cursor: pointer; }
        ...
        .notice { background: #dcfce7; color: #166534; border: 1px solid #86efac; padding: 10px; border-radius: 8px; margin-bottom: 12px; }
...
<div class="container">
    <div class="card">
        ...
        <form method="get" class="row">
            ...
            <div>
                <label>&nbsp;</label>
                <a href="form.php"><button type="button" class="secondary">Them sinh vien</button></a>
            </div>
        </form>
    </div>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($students)): ?>
                    <tr><td colspan="6">Chua co du lieu sinh vien</td></tr>
                <?php else: ?>
    ...
    <div class="card">
        ...
        <div class="row-3">
            ...
            <div>
                ...
                <table>
                    <thead><tr><th>Ma LHP</th><th>Mon hoc</th><th>So SV</th></tr></thead>
                    <tbody>
                    <?php foreach ($lhps as $lhp): ?>
                        <tr>
