...
<body class="font-body-md text-on-background">
	<div class="min-h-screen flex items-center justify-center p-6">
		<div class="max-w-2xl w-full bg-white rounded-2xl border border-slate-100 shadow-sm p-10 text-center">
			<div class="inline-flex items-center justify-center w-16 h-16 rounded-full bg-primary-container/20 text-primary mb-4">
				<span class="material-symbols-outlined text-3xl" data-icon="sentiment_dissatisfied">sentiment_dissatisfied</span>
			</div>
			<h1 class="text-4xl font-bold text-on-background mb-2">404</h1>
			<p class="text-body-md text-on-surface-variant">Trang ban tim khong ton tai hoac da bi di chuyen.</p>
